...
const LightControl = () => {
  ...
  const toggleLight = async (room) => {
    try {
      setIsLoading(true);
      const response = await fetch(`/api/lights/${room}/toggle`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const setBrightness = async (room, brightness) => {
    try {
      const response = await fetch(`/api/lights/${room}/brightness`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  return (
    <div className="p-6 min-h-screen bg-gray-100 dark:bg-[#23272f]">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <motion.button
            ...
            disabled={isLoading}
            className="bg-gradient-to-r from-indigo-300 to-blue-300 text-white py-3 px-4 rounded-2xl hover:from-indigo-400 hover:to-blue-400 flex items-center justify-center shadow-xl border border-[#444857] disabled:opacity-50"
          >
          ...
          <motion.button
            ...
            disabled={isLoading}
            className="bg-[#353a45] text-white py-3 px-4 rounded-2xl hover:bg-[#444857] flex items-center justify-center shadow-xl border border-[#444857] disabled:opacity-50"
          >
          ...
          <motion.button
            ...
            disabled={isLoading}
            className="bg-gradient-to-r from-yellow-200 to-yellow-300 text-white py-3 px-4 rounded-2xl hover:from-yellow-300 hover:to-yellow-400 flex items-center justify-center shadow-xl border border-[#444857] disabled:opacity-50"
          >
          ...
          >
            ...
            <div className="flex space-x-2">
              <button
                ...
                disabled={isLoading}
                className="flex-1 px-3 py-2 bg-gradient-to-r from-indigo-300 to-blue-300 text-white rounded-2xl text-sm font-medium hover:from-indigo-400 hover:to-blue-400 border border-gray-200 dark:border-gray-700 shadow-xl disabled:opacity-50"
              >
                Full
              </button>
              <button
      ...
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-white dark:bg-[#2d3340] border border-gray-200 dark:border-gray-700 shadow-xl rounded-2xl mt-8 p-6"
      >
